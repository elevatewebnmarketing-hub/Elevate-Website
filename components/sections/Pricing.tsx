...
const packages: PackageItem[] = [
  {
    ...
    features: [
      ...
      'Typical delivery: 1–2 weeks (based on content readiness)',
    ],
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      'Typical delivery: 3–6 weeks (depending on scope and revisions)',
    ],
    highlighted: true,
  },
  {
    ...
    features: [
      ...
      '2 rounds of revisions before final launch',
      '2 weeks post-launch support',
      'Typical delivery: 3–6 weeks (depending on scope and content readiness)',
    ],
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    features: [
      'Google Ads campaign setup and monthly optimization (1–3 core campaigns)',
